...
USING CAPACITIVE LOAD CELLS AND ACOUSTIC SPECTRA ANALYSIS
TO DETERMINE ROCK TYPE AND TOOL WEAR IN ROCK EXCAVATION PROCESS
    }
...
%% Remeber to add back in before upload %% ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
\input{chapter/02-mining_bg.tex}
\input{chapter/03-sensor_bg.tex}
\input{chapter/04-classification_regression_bg.tex}

\input{chapter/05-P1-Journal-Chapter}
\input{chapter/06-P2-Journal-Chapter}
\input{chapter/07-P3-Journal-Chapter}

% Extra Example Chapters If you want to See Special Cases with Table, Figure, or Equation formatting
\input{chapter/08-load_cell_compare} % comparison of p1 and p3
\input{chapter/09-acoustic_extension} % further results from p2
\input{chapter/10-extra_modelling_and_recs} % modelling of sensors expanded, and design improvements
\input{chapter/12-conclusions_attempt2} % future work
...
\bibliography{supporting-files/sources_flexpcb,supporting-files/sn-bibliography,supporting-files/airgap-bibliography,supporting-files/thesis,supporting-files/ch9}
