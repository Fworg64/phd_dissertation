...
Thin film deformation can be modelled using viscous elements, as shown in \ref{fig:sense_model}.
...
%    \node [right=4pt] at (3.0, -1) {$K_{w2}$} ; % wall 2 spring
    ...
    \caption{A model of the sensor as a system of springs and dampers. 
             The PI can be modelled with a general visco-elastic model with
...
The nonlinearity of the first design was not an issue for tool wear or material classification,
