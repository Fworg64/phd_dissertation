...
The steel case is assembled using the laser weld procedure described in \hlgr{appendix A}.
Simulation for the capacitance of the air gap is described in \hlgr{Appendix B}.
Additional MATLAB modelling for the sensor is described in \hlgr{Appendix C}.
